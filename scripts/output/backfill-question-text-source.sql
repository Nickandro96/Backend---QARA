...
WHERE questionKey IN (
  SELECT questionKey FROM questions WHERE questionTextSource IS NOT NULL
) AND 1 = 0; -- garde documentaire : utiliser la liste exacte du CASE pour un contrôle détaillé généré
