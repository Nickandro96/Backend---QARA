...
import { isWatchItemVisible } from "./watch-router";

const base = { aiAnalyzed: true, marketsImpacted: ["EU"], rolesImpacted: ["fabricant"], sourceRegistryId: "mdcg", criticality: "watch" as const };
