...
export const REGULATORY_SOURCE_REGISTRY: RegulatorySourceDefinition[] = [
  ...
  { id: "mdcg", name: "European Commission MDCG", urlBase: "https://health.ec.europa.eu/medical-devices-sector/new-regulations/guidance-mdcg-documents_en", type: "html", active: true, frequency: "daily", accessType: "public", commercialUseAllowed: null, licenceNotes: "Commercial reuse must be verified against the page notice.", authorityType: "official" },
